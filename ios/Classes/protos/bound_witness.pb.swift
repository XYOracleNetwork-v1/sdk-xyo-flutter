...
extension DeviceBoundWitnessList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.boundWitnesses) }()
      default: break
      }
    }
  }
...
extension DeviceBoundWitness: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.bytes) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.byteHash) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.humanName) }()
      case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.huerestics) }()
      case 5: try { try decoder.decodeRepeatedStringField(value: &self.parties) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.linked) }()
      default: break
      }
    }
  }
